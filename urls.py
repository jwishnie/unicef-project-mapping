...
urlpatterns += patterns('maplayers',
                        ...
                        (r'^projects/nearby/(?P<left>.+)/(?P<bottom>.+)/(?P<right>.+)/(?P<top>.+)/$',
                         'views.nearby_projects'),
                         (r'^projects/id/(?P<project_id>\d+)/$', 'views.project'),
                         (r'^$', 'views.homepage'),
                         (r'^projects/search/$','views.projects_search'),
                         ...
                         (r'^project/comments/(?P<project_id>\d+)/all/(?P<mode>\w+)/$', 'views.all_comments'),
...
urlpatterns += patterns('maplayers.project_admin_views',
                        ...
                        (r'^projects/photo_upload/$','photo_upload'),
                        (r'^remove_photo/$','remove_photo'),
...
urlpatterns += patterns('maplayers.admin_views',
                        ...
                        (r'^delete_admin_unit/$', 'delete_administrative_unit'),
